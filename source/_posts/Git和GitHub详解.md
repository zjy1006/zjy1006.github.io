...
categories:
  - git
keywords: 'git,github'
cover: 'https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/黑发女孩.jpg'
comments: false
abbrlink: 40e6270a
date: 2020-01-14 03:09:19
updated:
---
...
> ![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图1.png)
>
> 主要涉及到四个关键点：
>
...
> 
>
> ![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图2.png)
>
> 
>
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/20191115154237.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/20191115164339.png)
...
2.  Github添加公钥
   ...
   ![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/20191115165957.png)

3. 复制SSH地址：

   ![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/20191115170348.png)
...
6. 点击“取消”按钮，弹出如下提示框：
   ![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图3.png)
...
菜单栏，“工具”——“选项”，如图所示：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图4.png)

选择“比较”选项卡，然后将红色方框处的内容修改为如图所示：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图5.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图6.png)

​	本地存在的git项目，
​	获取项目克隆地址，点击克隆按钮，如图所示：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图7.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图8.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图9.png)

鼠标右键要忽略的文件，点击“忽略”，选择忽略的模式，即可将文件进行忽略，如图所示：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图10.png)

#### （3）tag使用方法

​	打tag的目的是在代码的主要节点处有个标记，方便下次修改代码时可以准确的找到想要找的代码。而无需看着日志文件逐一回忆要找的代码位置。
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图11.png)
...
​	3、分支的添加很简单
分支添加：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图12.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图13.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图14.png)

​	点击Stage All，填写提交信息既可以将本地内容（暂存区）提交到本地版本库，如图所示：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图15.png)
...
​	简单介绍
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图16.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图17.png)

​	解决冲突

​	方法一：在相关的版本处，选中”冲突行”，合并区默认处于合并位置，鼠标右键，选择最终冲突地方留下的内容，如图：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图18.png)

​	解决冲突之后效果图：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图19.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图20.png)

​	1、点击未暂存区域的冲突文件。
​	2、右侧列表中出现冲突的内容。
​	3、选择冲突内容，解决冲突，如图所示：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图21.png)
...
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图22.png)

​	1、切换到日志/历史标签
​	2、选择要恢复到的版本，如图蓝色位置
​	3、鼠标右键，选择“重置当前分支到此次提交”
​	4、选择”重置模式”，如图所示
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图23.png)

​	5、弹出框中选择”Yes”
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图24.png)

#### （9）相关提示信息含义

​	冲突信息
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图25.png)

​	先更新信息
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图26.png)
​	小窍门：
![](https://gitee.com/zhou_jin_yuan/blogimage/raw/master/img/Git和GitHub详解图27.png)
